...
3. **Environment Setup**
   ...
   When using an external Better Auth server (e.g. the `apps/server` Cloudflare Worker in this repo), set:

   ```dotenv
   NEXT_PUBLIC_AUTH_BASE_URL=https://<your-auth-server-domain>
   ```
